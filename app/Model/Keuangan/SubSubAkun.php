...
class SubSubAkun extends Model
{
	...
	protected $fillable = ['id_sub_akun_ukm','id_sub_sub_master_akun','kode_subsub_akun','nm_subsub_akun','off_on','status_alur_kas','posisi_saldo','id_perusahaan','id_karyawan'];
