...
class POrder extends Model
{
    ...
    protected $fillable = ['id_po','tgl_order','no_order','id_supplier','tgl_tiba','diskon_tambahan','pajak','dp_po','bayar','kurang_bayar','metode_bayar','tgl_jatuh_tempo','ongkir','ket','total','id_perusahaan','id_karyawan'];
