...
class PSO extends Model
{
    ...
    protected $fillable = ['id_tawar_beli','tgl_so','no_so','id_po','id_klien','tgl_dikirim','diskon_tambahan','pajak','dp_so','kurang_bayar','ket','metode_pajak','status','id_perusahaan'];
