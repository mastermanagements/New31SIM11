...
class PSO extends Model
{
    ...
    protected $fillable = ['id_tawar_beli','tgl_so','no_so','no_po','id_klien','tgl_dikirim','diskon_tambahan','pajak','total','dp_so','kurang_bayar','ket','status','id_perusahaan','id_karyawan'];
