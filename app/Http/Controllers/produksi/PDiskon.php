...
class PDiskon extends Controller
{
    ...
    public function store(Request $req){
        ...
        $model->diskon_nominal = $req->diskon_nominal;
    ...
    public function update(Request $req, $id){
        ...
        if($model->save()){
            return redirect('Penjualan')->with('message_success', 'Diskon telah diubah');
        }else{
            return redirect('Penjualan')->with('message_fail', 'Diskon gagal diubah');
        }
    }
