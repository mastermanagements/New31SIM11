...
class Karyawan extends Controller
{
    ...
    public function data_karyawan($id_usaha)
    {
        ...
        $data_pass = [
            ...
            'data_karyawan'=> karyawans::all()->where('id_perusahaan', $id_usaha),
            'id_usaha'=> $id_usaha
        ];
    ...
    public function store(Request $req)
    {
        ...
        $name_file_ktp = time().".".$file_ktp->getClientOriginalExtension();
        $name_file_cv= time().".".$cu_vitae->getClientOriginalExtension();
        $name_file_pfoto= time().".".$pas_foto->getClientOriginalExtension();
    ...
    {
        if(empty($data_usaha = karyawans::where('id', $id_karyawan)->where('id_user_ukm', $this->id_superadmin)->where('id_perusahaan', $id_usaha)->first()))
        {
            return abort(404);
        }
