(function() {
  function embed () {
    ...
    function trackUplift() {
      try {
        var url = 'https://codefund.io/impressions/e1451654-17aa-49eb-a7a2-47745e159891/uplift?advertiser_id=185';
    ...
    try {
      ...
      codeFundElement.innerHTML = '<div id="cf" style="font-family: Helvetica, Arial; font-size: 13px;"> <span class="cf-wrapper" style="box-sizing: border-box; position: fixed; bottom: 0; z-index: 5000; width: 100%; border-top-width: 1px; border-top-color: #bfbfbf; border-top-style: solid; background-color: #eeeeee; text-align: center; line-height: 1.5; padding: 0.8em 1em 1em;"> <a data-href="campaign_url" class="cf-text" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; color: inherit; text-decoration: none;"> <strong>#ClimateStrike</strong> <span>- The Global Climate Strike is Happening Now. Join the movement.</span> </a> <a href="https://codefund.app" data-target="powered_by_url" class="cf-powered-by" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; font-size: 12px; text-decoration: none; color: #999;"> <em>ethical</em> ad by CodeFund <img data-src="impression_url"> </a> </span> </div> <style>#cf .cf-text:before { margin-right: 4px; padding: 2px 6px; border-radius: 3px; background-color: #4caf50; color: #fff; content: \'Supporter\'; } #cf .cf-powered-by::before { content: \' \'; color: rgba(0, 0, 0, 0.3); display: inline-block; } </style>';
      codeFundElement.querySelector('img[data-src="impression_url"]').src = 'https://codefund.io/display/e1451654-17aa-49eb-a7a2-47745e159891.gif';
      codeFundElement.querySelectorAll('a[data-href="campaign_url"]').forEach(function (a) { a.href = 'https://codefund.io/impressions/e1451654-17aa-49eb-a7a2-47745e159891/click?campaign_id=454&creative_id=433&property_id=441&template=bottom-bar&theme=light'; });
