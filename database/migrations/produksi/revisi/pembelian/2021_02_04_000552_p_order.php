...
class POrder extends Migration
{
    ...
    public function up()
    {
        Schema::create('p_order', function (Blueprint $table) {
            ...
            $table->enum('status_cekbarang',['0','1'])->default(0)->comment('0=belum dicek,1 = sudah dicek');
            $table->enum('respon_supplier',['0','1'])->default(0)->comment('0=belum direspon,1 = sudah direspon');
