...
Route::get('pengaturan-menu-tambahan/{id}', 'Superadmin_ukm\Menu_perusahaan@daftar_menu_tambahan');
...
//--- Kompetitor ---
Route::get('Kompetitor', 'karyawan\Kompetitor@index');

Route::get('tambah-kompetitor', 'karyawan\Kompetitor@create');

Route::post('store-kompetitor', 'karyawan\Kompetitor@store');

Route::get('ubah-kompetitor/{id}', 'karyawan\Kompetitor@edit');

Route::put('update-kompetitor/{id}', 'karyawan\Kompetitor@update');

Route::put('hapus-kompetitor/{id}', 'karyawan\Kompetitor@delete');

Route::get('detail-kompetitor/{id}', 'karyawan\Kompetitor@detail');

Route::get('getKabupatenK/{id_provinsi}', 'karyawan\Kompetitor@ResponseKabupaten');
...
//buku penilaian kinerja karyawan (Performance-Appraisal)
...
Route::get('Periode-Investasi', 'investor\BentukInvestor@index');

Route::post('store-periode-investasi', 'investor\BentukInvestor@store');

Route::get('edit-periode-investor/{id}', 'investor\BentukInvestor@edit');

Route::post('update-periode-investor', 'investor\BentukInvestor@update');

Route::put('hapus-periode-investor/{id}', 'investor\BentukInvestor@delete');
...
Route::get('laporan-produksi-per-ky', 'manufaktur\Manufaktur@laporan_produksi_karyawan');
Route::post('laporan-produksi-per-ky', 'manufaktur\Manufaktur@PrinView_OrCetak_Karyawan');
