            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-warning">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ url('update-proposal/'.$data_proposal->id) }}" method="post">
                            <div class="box-body">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="id_jenis_prop" required>
                                        ...
                                        @else
                                            @foreach($jenis_proposal as $value)
                                                <option value="{{ $value->id }}" @if($data_proposal->id_jenis_prop == $value->id) selected @endif>{{ $value->jenis_proposal }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_prop" class="form-control" id="exampleInputEmail1" value="{{ $data_proposal->judul_prop }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Proposal" value="{{ date('d-m-Y', strtotime($data_proposal->tgl_prop)) }}" name="tgl_prop" required>
                                    </div>
                                    <!-- /.input group -->
                                    <small style="color: red">* Tidak boleh kosong</small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ditujukan" class="form-control" id="exampleInputEmail1" value="{{ $data_proposal->ditujukan }}" required>
                                    <small style="color: red">* Tidak Boleh Kosong</small>
                                </div>
