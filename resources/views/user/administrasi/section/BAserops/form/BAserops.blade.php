...
<form action="{{ url('BA-Serops-store') }}" method="post" enctype="multipart/form-data">
<div class="col-md-8">
    <div class="box-body">
      <div class="form-group">
           <label for="exampleInputEmail1">Isi Berita Acara Serah Terima Operasional</label>
           <textarea class="form-control" placeholder="Masukan Isi Berita Acara Serah Terima Operasional" name="isi_serops" id="isi_serops" required></textarea>
            ...
            <div class="form-group">
                <label for="exampleInputEmail1"></label>
                 <span class="btn btn-default btn-file" >
                    ...
                    <label>Unggah File BA. Serah Terima </label><input type="file" name="file_serops"><br>
