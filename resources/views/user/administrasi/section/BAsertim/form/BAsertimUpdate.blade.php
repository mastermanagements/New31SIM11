...
<div class="col-md-8">
    <div class="box-body">
      <div class="form-group">
           ...
           <textarea class="form-control" placeholder="Masukan Isi Berita Acara Sertah Terima" name="isi_basertim" id="isi_basertim" required>{!! $dataSertimById->isi_basertim !!}</textarea>
