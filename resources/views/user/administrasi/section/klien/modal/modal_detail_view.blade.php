            ...
            <form action="{{ url('ganti-jenis-klien-leads') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="form-group">
                                <label>
                                    <input type="radio"  name="jenis_klien" class="minimal" value="2" required> Prospect (Cold Customer)
                                </label>
                            <p></p>
...
<!-- /.modal -->
<div class="modal fade" id="modal-ganti-prospect">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('ganti-jenis-klien-prospect') }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Pindah Jenis Customer Ke</h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="form-group">
                                <label>
                                    <input type="radio"  name="jenis_klien" class="minimal" value="3" required> Potential (Warm Customer)
                                </label>
                            <p></p>
                            <small style="color: red">* Tidak Boleh Kosong</small>
                        </div>
...
<!-- /.modal -->
<div class="modal fade" id="modal-ganti-potential">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('ganti-jenis-klien-potential') }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Pindah Jenis Customer Ke</h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="form-group">
                                <label>
                                    <input type="radio"  name="jenis_klien" class="minimal" value="4" required> Closeable (Hot Customer)
                                </label>
                            <p></p>
                            <small style="color: red">* Tidak Boleh Kosong</small>
                        </div>
...
<!-- /.modal -->
<div class="modal fade" id="modal-ganti-closeable">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('ganti-jenis-klien-closeable') }}" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Pindah Jenis Customer Ke</h4>
