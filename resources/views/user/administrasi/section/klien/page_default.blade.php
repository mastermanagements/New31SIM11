            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_3" data-toggle="tab">Prospect(Cold Customer)</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Potential(Warm Customer)</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Closeable(Hot Customer)</a></li>
                    ...
                    <div class="tab-content">
						...
						<div class="tab-pane" id="tab_3">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                ...
                                <tbody>
								@php($a=1)
                                @foreach($data_prospect as $value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value->nm_klien }}</td>
                                        <td>
                                        ...
                                        <td>
											...
											<button class="btn btn-primary" onclick="gantiProspect('{{ $value->id }}');" title="Ubah Status Customer"><i class="fa fa-file-picture-o"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
						...
						<div class="tab-pane" id="tab_4">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                ...
                                <tbody>
								@php($a=1)
                                @foreach($data_potential as $value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value->nm_klien }}</td>
                                        <td>
                                        ...
                                        <td>
											...
											<button class="btn btn-primary" onclick="gantiPotential('{{ $value->id }}');" title="Ubah Status Customer"><i class="fa fa-file-picture-o"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
						...
						<div class="tab-pane" id="tab_5">
                            ...
                            <table id="example3" class="table table-bordered table-striped">
                                ...
                                <tbody>
								@php($a=1)
                                @foreach($data_closeable as $value)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $value->nm_klien }}</td>
                                        <td>
                                        ...
                                        <td>
											...
											<button class="btn btn-primary" onclick="gantiCloseable('{{ $value->id }}');" title="Ubah Status Customer"><i class="fa fa-file-picture-o"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
