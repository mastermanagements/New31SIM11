<div class="col-md-12">
    <div class="form-group">
        <a href="{{ url('laporan-brg-dan-harga-jual') }}" class="btn btn-info">Daftar Barang & Harga Jual</a>
        <a href="{{ url('laporan-masuk-keluar-barang') }}" class="btn btn-info">Item Masuk keluar Barang</a>
