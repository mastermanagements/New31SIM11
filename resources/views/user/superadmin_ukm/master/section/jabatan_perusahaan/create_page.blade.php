...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           Halaman Tambah Jabatan {{ $usaha->nm_usaha }}
        </h1>
    </section>
       ...
       <div class="row">
           <div class="col-md-8">
               ...
               <div class="box box-primary">
                   ...
                   <!-- /.box-header -->
                   <!-- form start -->
                   <form role="form" method="post" action="{{ url('store-jabatan') }}" enctype="multipart/form-data">
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" class="form-control" placeholder="Masukan Nama Jabatan Anda" name="nm_jabatan" required>
                           ...
                           <div class="form-group">
                               ...
                               <div class="form-group">
                                   ...
                                   <label>
                                       <input type="radio" name="level_jabatan" class="minimal" value="4">
                                       Bagian Keuangan
                                   </label>
                                   <label>
                                       <input type="radio" name="level_jabatan" class="minimal" value="5">
                                       Bagian HRD
                                   </label>
                                   <label>
                                       <input type="radio" name="level_jabatan" class="minimal" value="6">
                                       Bagian Penggajian
                                   </label>
                               </div>
                               <small style="color: red">* Tidak Boleh Kosong</small>
