    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12" >
                    <form action="{{ url('cari-tes-kt') }}" method="post" style="width: 100%">
                        ...
                        <div class="box box-primary collapsed">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <a href="{{ url('formulir-tes-kompetensi-teknis/'. $value->id) }}" class="btn btn-success" ><i class="fa fa-plus"></i> Penilaian</a>
                            ...
                            <div class="box-body" style="">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach($value->get_MannyTesTeknis->sortByDesc('thn_tes_kt')->groupBy('thn_tes_kt') as $tahun => $penilaian)
                                            <tr>
                                                <th>{{ $tahun }}</th>
                                                <th>
                                                    @php($nilai_total = 0)
