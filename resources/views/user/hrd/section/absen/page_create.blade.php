        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('store-absensi') }}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Mulai Kerja Per Bulan" name="periode" required>
                                </div>
                                <!-- /.input group -->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="normal_hari">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="terlambat_masuk">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tidak Absen Masuk</label>
                                <input type="number" class="form-control" name="tdk_absen_m">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tidak Absen Pulang</label>
                                <input type="number" class="form-control" name="tdk_absen_p">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Jumlah Izin Bulan Ini</label>
                                <input type="number" class="form-control" name="jum_izin">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                       </div>
                        <!-- /.box-body -->
