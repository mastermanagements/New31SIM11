<div class="tab-pane active" id="tab_1">
    <div class="row">
        <div class="col-md-12">
            <label style="font-size: 23px">Wawancara</label>
            <a href="{{ url('item-wawancara') }}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Item Wawancara</a>
        </div>

        <div class="col-md-12" style="padding-top: 5px">
            <form action="{{ url('cari-loker-wawancara') }}" method="post" style="width: 100%">
                                ...
                                @foreach($data_lamaran_pek as $key=> $data_lamaran_pek)
                                    ...
                                    @if($data_lamaran_pek->seleksi_berkas['hasil']==1)
                                        <tr>
                                            ...
                                            <td><a href="{{ url('mulai-wawancara/'.$data_lamaran_pek->id) }}" class="btn bg-green" ><i class="fa fa-file-text" ></i> Mulai Wawancara </a></td>
                                        </tr>
                                    @endif
                                @endforeach
                            @endif
