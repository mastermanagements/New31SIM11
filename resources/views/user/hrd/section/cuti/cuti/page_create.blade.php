        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('store-cuti') }}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker" placeholder="Tahun Cuti" name="periode" required>
                                </div>
                                <!-- /.input group -->
                                ...
                                <select class="form-control select2" style="width: 100%;" name="id_setting_cuti" required>
                                    ...
                                    @else
                                        @foreach($pengaturan_cuti as $value)
                                            <option value="{{ $value->id }}">{{ $value->nm_cuti }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" name="max_suci" class="form-control">
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
