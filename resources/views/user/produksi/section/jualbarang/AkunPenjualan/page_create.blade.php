            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Tambah Akun Penjualan</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                      <div class="box-body">
                          <div class="row">
                              <form role="form" action="{{ url('pengaturan-akun-penjualan') }}" method="post">
                              {{ csrf_field() }}
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <select class="form-control select2" name="id_ket_transaksi">
                                                    @if(!empty($akun_transaksi))
                                                        @foreach($akun_transaksi as $akun_transaksi)
                                                            <option value="{{ $akun_transaksi->id }}">{{ $akun_transaksi->nm_transaksi }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
