            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Pemeliharaan</a></li>
                        <li class="pull-right"><a href="#tab_2" data-toggle="tab"><i class="fa fa-list"></i> Jenis Pemeliharaan</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <a href="{{ url('tambah-jenis-proyek') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Jenis Pemeliharaan</a>
                            <p></p>
