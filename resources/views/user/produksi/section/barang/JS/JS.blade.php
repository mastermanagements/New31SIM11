<script>
        ...
        $.ajax({
           ...
           data : {
            ...
            success: function (result) {
                console.log(result);
                var option= "<option value='0'>pilih kategori barang diatas terlebih dahulu</option> ";
    ...
    $('[name="id_subkategori_produk"]').change(function () {
        $.ajax({
            ...
            success: function (result) {
                console.log(result);
                var option= "<option value='0'>pilih sub kategori Barang diatas terlebih dahulu</option> ";
                $.each(result.data, function (index, value) {
