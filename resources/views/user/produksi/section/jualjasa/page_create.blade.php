        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('store-jual-jasa') }}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="id_jasa" required>
                                    ...
                                    @else
                                        @foreach($data_jasa as $value)
                                            <option value="{{ $value->id }}">{{ $value->nm_jasa }}</option>
                                        @endforeach
                                    @endif
                                </select>
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0"  name="harga_jual" class="form-control" placeholder="Harga Jual" required/>
                                <small style="color: red">* Tidak boleh kosong</small>
                            </div>
