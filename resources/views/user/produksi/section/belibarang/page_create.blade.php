        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('store-beli-barang') }}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Barang dibeli" name="tgl_beli" >
                                </div>
                                <!-- /.input group -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="harga_beli" class="form-control" placeholder="Harga barang" />
