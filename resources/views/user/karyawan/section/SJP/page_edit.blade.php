        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-warning">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('ubah-sjp/'.$data_strategi->id) }}" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Periode</label>
                                <input type="number" min="1" max="50" name="periode" class="form-control" id="exampleInputEmail1" placeholder="Contoh: 5 tahun, 10 tahun, dll" value="{{ $data_strategi->periode }}" required>
