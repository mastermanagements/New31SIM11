            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-warning">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ url('update-JD/'. $jobDecks->id) }}" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="id_jabatan_p" required>
                                        @foreach($jabatan as $value)
                                            <option value="{{ $value->id }}" @if($value->id==$jobDecks->id_jabatan_p) selected @endif>{{ $value->nm_jabatan }}</option>
                                        @endforeach
                                    </select>
