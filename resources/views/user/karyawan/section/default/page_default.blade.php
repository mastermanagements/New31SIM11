                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header">
                            <h4 class="box-title">Agenda Harian</h4>
                        </div>
                        <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-danger">
                                <div class="box-header">
                                    <h4 class="box-title">Produksi</h4>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box box-info">
                                                <div class="box-body" style="background-color: deepskyblue">
                                                    <h4>Produksi Bulanan : {{ date('d-m-Y') }}</h4>
                                                    <ol>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box box-info">
                                                <div class="box-body" style="background-color: deepskyblue">
                                                    <h4>Pengeluaran Bulan ini : {{ date('d-m-Y') }}</h4>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="box box-info">
                                                <div class="box-body" style="background-color: deepskyblue">
                                                    <h4>Penjualan Bulan ini : {{ date('d-m-Y') }}</h4>
