        ...
        <div class="row">
            <div class="col-md-7">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('store-investor') }}" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nm_investor" class="form-control" id="exampleInputEmail1" required>
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tmp_lahir" class="form-control" id="exampleInputEmail1" required>
                                <small style="color: red">* Tidak Boleh Kosong</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    @foreach($jenkel as $value)
                                        <label>
                                            <input type="radio"  name="jenis_kel" class="minimal" value="{{ $value }}" required>
                                            {{ $value." " }}
                                        </label>
                                     @endforeach
                                    <p></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    @foreach($agama as $value)
                                        <label>
                                            <input type="radio"  name="agama" class="minimal" value="{{ $value }}" required>
                                            {{ $value." " }}
                                        </label>
                                     @endforeach
                                    <p></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    @foreach($status_perkawinan as $value)
                                        <label>
                                            <input type="radio"  name="status_perkawinan" class="minimal" value="{{ $value }}" required>
                                            {{ $value." " }}
                                        </label>
                                     @endforeach
                                    <p></p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nm_bank" class="form-control" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">No. Rekening Bank</label>
                                <input type="text" name="no_rek" class="form-control" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Pendidikan Terakhir</label>
                                <input type="text" name="pend_akhir" class="form-control" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama Cabang Bank.</label>
                                <input type="text" name="kantor_cabang" class="form-control" id="exampleInputEmail1" >
                            </div><div class="form-group">
                                <label for="exampleInputEmail1">No.Rekening Bank Cabang</label>
                                <input type="text" name="no_rek_bank" class="form-control" id="exampleInputEmail1" >
                            </div>
                        </div>
                        <!-- /.box-body -->
